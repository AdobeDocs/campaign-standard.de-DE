...
Sie können Ihre Ziel-Zielgruppe beliebig aufteilen und Ihren Versand beispielsweise in fünf Teilsendungen versenden. Sie senden einen ersten Batch, der 10 % Ihrer Zielgruppe entspricht, am 1. Juni um 10:00 Uhr und einen zweiten Batch 24 Stunden später mit 15 % der Zielgruppe und so weiter.
...
1. Wählen Sie eine Zielgruppe aus, z. B. alle Ihre Gold-Kunden und klicken Sie auf **[!UICONTROL Bestätigen]**, um die Abfrage zu speichern.
...
1. Definieren Sie fünf Segmente. Gehen Sie für jedes Segment folgendermaßen vor:
   ...
   * Füllen Sie das Feld **[!UICONTROL Segmentcode]** aus: Geben Sie manuell den gewünschten Zeitpunkt für den Versand der Nachricht ein.
     ...
     Beispiel: Sie möchten den ersten Batch am 1. Juni um 10:00 Uhr GMT+1 senden. Verwenden Sie das folgende Format: **`YYYY-MM-DD hh:mm:ss+tz`**.
...
Beispiel: Sie laden in einer E-Mail Ihre Kunden ein, das Callcenter zu kontaktieren, um ein Werbeangebot einzulösen. Damit das Callcenter nicht mit Anrufen überflutet wird, segmentieren Sie Ihre Ziel-Zielgruppe zufällig und senden Ihre E-Mails in vier Teilsendungen.
...
1. Gehen Sie in die Liste der Marketing-Aktivitäten und erstellen Sie einen neuen Workflow. Lesen Sie diesbezüglich auch den Abschnitt [Workflows erstellen](../../automating/using/building-a-workflow.md#creating-a-workflow).
1. Ziehen Sie eine **Abfrage** in den Workflow-Arbeitsbereich und öffnen Sie sie. Siehe den Abschnitt [Abfrage](../../automating/using/query.md).
1. Wählen Sie eine Zielgruppe aus, z. B. 35 Profile, und klicken Sie auf **[!UICONTROL Bestätigen]**, um die Abfrage zu speichern.
1. Ziehen Sie eine **Segmentierung** in den Workflow-Arbeitsbereich und öffnen Sie sie. Siehe den Abschnitt [Segmentierung](../../automating/using/segmentation.md).
1. Definieren Sie vier Segmente. Gehen Sie für jedes Segment folgendermaßen vor:

   * Definieren Sie die Segmentcodes:

      * 8:00 Uhr – 10:00 Uhr: **0**. Die Nachricht wird um 8:00 Uhr (Kontaktdatum) an das erste Viertel der Zielpopulation gesendet.
      * 10:00 Uhr – 12:00 Uhr: **2**. Die Nachricht wird um 10:00 Uhr an das zweite Viertel der Zielpopulation gesendet (Kontaktdatum + 2 Stunden).
      * 14:00 Uhr – 16:00 Uhr: **6**. Da das Callcenter zwischen 12:00 Uhr und 14:00 Uhr geschlossen ist, wird die Nachricht um 14:00 Uhr an das dritte Viertel der Zielpopulation gesendet (Kontaktdatum + 6 Stunden).
      * 16:00 Uhr – 18:00 Uhr: **8**. Die Nachricht wird um 16:00 Uhr an das letzte Viertel der Zielpopulation gesendet (Kontaktdatum + 8 Stunden).
...
1. Definieren Sie im Feld **[!UICONTROL Start des Versands am]** ein Kontaktdatum.
   ...
   Wählen Sie in diesem Beispiel den 25. Mai um 8:00 Uhr aus.
...
* Das erste Segment erhält die Nachricht am Kontaktdatum (25. Mai um 8:00 Uhr).
* Das zweite Segment erhält die Nachricht zwei Stunden später (25. Mai um 10:00 Uhr).
* Das dritte Segment erhält die Nachricht sechs Stunden später (25. Mai um 14:00 Uhr).
* Das vierte Segment erhält die Nachricht acht Stunden später (25. Mai um 16:00 Uhr).
