...
* [Typologien verwalten](../../sending/using/about-typology-rules.md#managing-typologies)
* [Typologieregeln](../../sending/using/about-typology-rules.md#typology-rules)
...
1. Select the **[!UICONTROL Typologies]** tab and link your typology rule to the typology used for your deliveries. Siehe [Typologien verwalten](../../sending/using/about-typology-rules.md#managing-typologies) und [Typologieregeln](../../sending/using/about-typology-rules.md#typology-rules).
...
Standardmäßig werden bei der Schwellenberechnung alle Nachrichten berücksichtigt. Markieren Sie das **[!UICONTROL Refine Threshold on profiles and deliveries]** Kästchen, um die Profil und Versand zu filtern, die beim Vorbereiten des Versands gezählt werden sollen.
...
* **[!UICONTROL Refine threshold on profiles and deliveries > Deliveries to count]**: Alle Versand, die diese Typologieregel verwenden, führen die Regel aus. Sie entscheiden jedoch unter den vorherigen und geplanten Versänden, welche gezählt werden sollen. Wenn beispielsweise Ihre Beschränkung ‚Titel beginnt mit Newsletter‘ lautet, wird die Regel ausgeführt, selbst wenn der Versandtitel mit &#39;Promo‘ beginnt. Gezählt wird die Anzahl der Sendungen im ausgewählten beweglichen Zeitraum, deren Titel mit &#39;Newsletter‘ beginnt.
...
* **[!UICONTROL Total targeted]**: die gesamte Zielgruppe vor der Nachrichtenvorbereitung
* **[!UICONTROL Excluded]**: die Gesamtzahl der Ausschlüsse aufgrund der Anwendung der Ermüdungsregel
* **[!UICONTROL Other exclusions]**: Gesamtzahl der Ausschlüsse aufgrund anderer Typologieregeln
...
1. Klicken Sie im **[!UICONTROL List of functions]** Abschnitt Dublette-Klick auf die **Iif** -Funktion im **[!UICONTROL Others]** Knoten.
