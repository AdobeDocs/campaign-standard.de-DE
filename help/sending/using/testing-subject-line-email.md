...
* Sie haben die Möglichkeit, unter Verwendung der Funktion [Package-Import](../../automating/using/managing-packages.md) vortrainierte, für spezifische Branchen entwickelte Modelle zu importieren (Medizin etc.). Klicken Sie [hier](https://support.neolane.net/webApp/extranetLogin) und gehen Sie zum **[Download-Center]**, um auf diese Modelle zuzugreifen. Diese Modelle können nicht trainiert werden.
