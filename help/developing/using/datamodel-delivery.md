---
title: DataModel-Bereitstellung
...
Nach Ausführungstyp (byExecutionType)
...
Nach Veröffentlichungsstatus (byPublicationStatus)
...
Erweiterte Sendungen einschließen (withAdvanced)
...
Testsendungen einschließen (withFCP)
...
Innerhalb des angegebenen Zeitraums geplant (byPlanning)
...
Vordefinierte anzeigen (showOob)
