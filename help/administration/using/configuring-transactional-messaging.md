...
seo-title: Transaktionsnachrichten konfigurieren
description: Transaktionsnachrichten konfigurieren
seo-description: Hier erfahren Sie, wie Transaktionsnachrichten konfiguriert werden.
...
1. Wählen Sie für das Ereignis einen **[!UICONTROL Titel]** und eine **ID[!UICONTROL .]** Das Feld **[!UICONTROL ID]ist ein Pflichtfeld und sollte mit dem Präfix "EVT" beginnen.** Bei Nichtverwendung des EVT-Präfixes in Ihrer Kennung wird dieses automatisch hinzugefügt, sobald Sie die Schaltfläche **[!UICONTROL Erstellen verwenden]**.

   ![](assets/message-center_1.png)

   >[!CAUTION]
   >
   >Die ID darf maximal 64 Zeichen lang sein, einschließlich des EVT-Präfix.
...
1. Wählen Sie im Bereich **[!UICONTROL Kollektionen]** die Schaltfläche **Element erstellen]aus.[!UICONTROL **
...
Sie können Transaktionsnachrichten mit Informationen aus den erweiterten Ressourcen **[!UICONTROL Profil]** oder **Dienst]anreichern.[!UICONTROL **

Diese Informationen können auch in neuen Ressourcen gespeichert werden. In diesem Fall muss die Ressource mit den Ressourcen **[!UICONTROL Profil]** oder **Dienst]entweder direkt oder über eine andere Tabelle verknüpft werden.[!UICONTROL ** Beispielweise können Sie in der folgenden Konfiguration die Transaktionsnachricht mit Informationen aus der Ressource **[!UICONTROL Produkt]** wie etwa einer Produktkategorie oder einer Kennung anreichern, wenn die Ressource **[!UICONTROL Produkt]mit der Ressource** Profil] verknüpft ist.**[!UICONTROL **
...
1. In unserem Beispiel stimmen wir die Felder **[!UICONTROL Nachname]** und **[!UICONTROL Vorname]mit den entsprechenden Feldern der Ressource** Profil] ab.**[!UICONTROL **
...
Nach der Publikation des Ereignisses sowie der Nachricht lässt sich der Inhalt der Transaktionsnachricht über die Relation mit der Ressource **[!UICONTROL Profil]anreichern.**
