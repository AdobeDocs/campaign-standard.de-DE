...
Email Feedback Service – [mehr dazu](../../sending/using/confirming-the-send.md#email-feedback-service)
...
Der Abschnitt **E-Mail-Kanal konfigurieren** wurde aktualisiert, um die neuesten E-Mail-Einstellungen zu erläutern. Einige ältere Parameter, die noch für bestimmte Kunden verwendet werden, sind unten auf dieser Seite aufgelistet. [Mehr dazu](../../administration/using/configuring-email-channel.md)
...
Der Abschnitt zu den ersten Schritten mit **Transaktionsnachrichten** enthält jetzt [erweiterte Schemas](../../channels/using/getting-started-with-transactional-msg.md#transactional-messaging-operating-principle) und einen [vollständigen Anwendungsfall](../../channels/using/transactional-messaging-use-case.md), um den Implementierungsprozess zu illustrieren. [Mehr dazu](../../channels/using/getting-started-with-transactional-msg.md)
...
Der Abschnitt über persönliche Daten und Personas wurde um ein Verwendungsfallszenario bereichert, um zu veranschaulichen, wie die verschiedenen Personen in Bezug auf die Privatsphäre interagieren – [mehr dazu](../../start/using/privacy.md#use-case-scenario)
