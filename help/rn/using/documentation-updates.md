...
Es wurde ein Hinweis hinzugefügt, dass der Versand von Testsendungen mithilfe der Profilersetzung den Protokollen der ausgewählten Profile Datensätze hinzufügt. [Mehr dazu](../../sending/using/testing-messages-using-target.md)
