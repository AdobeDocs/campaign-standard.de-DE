...
**Deklarierte** IDdata-Quelle kann jetzt auch mit der Integration des Hauptdienstes People verwendet werden. Informationen wurden in der Dokumentation zur Integration von Kampagne-Audience Manager oder People core service hinzugefügt. [Mehr dazu](../../integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)

Es wurden Informationen zur Implementierung der lokalen Verfolgung für mobile Anwendungen hinzugefügt. [Mehr dazu](../../administration/using/local-tracking.md)

Der Abschnitt [Auslieferbarkeit](../../sending/using/about-deliverability.md) wurde aktualisiert und enthält nun Links zum neuen Leitfaden [Best Practice Guide](https://experienceleague.corp.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/introduction.html) zur Auslieferung von Adoben. Alle generischen Informationen zur Lieferbarkeit, die für verschiedene Adoben gelten können, wurden in den [Best Practice Guide Anhang](https://experienceleague.corp.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/additional-resources/general-resources.html#additional-resources) verschoben.
...
Verweise auf die alte Support-Website wurden durch die neue URL ersetzt – [mehr dazu](https://helpx.adobe.com/de/campaign/kb/ac-support.html)
