...
Die Breadcrumb-Leiste des Inhaltseditors wird im Abschnitt [Verwaltung der Blöcke](../../channels/using/managing-landing-page-structure-and-style.md) beschrieben.
