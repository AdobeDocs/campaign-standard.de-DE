...
* Ein **[!UICONTROL Routing]** Externe Konto, das auf dem **[!UICONTROL Mobile (SMS)]** Kanal mit dem **[!UICONTROL Bulk delivery]** Modus konfiguriert wurde. Lesen Sie diesbezüglich auch den Abschnitt [Routing](../../administration/using/configuring-sms-channel.md#defining-an-sms-routing).
