...
1. Gehen Sie in den **[!UICONTROL Zielgruppe]**-Tab der Aktivität und ziehen Sie das Element **[!UICONTROL Versandlogs (logs)]** aus dem Bereich **[!UICONTROL E-Mail]** in den Arbeitsbereich.
