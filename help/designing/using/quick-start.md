...
1. Wählen Sie auf der Startseite von Email Designer, die sich über das Startseitensymbol aufrufen lässt, den Tab **[!UICONTROL Eigenschaften]** aus und füllen Sie den Bereich **[!UICONTROL Betreff]** aus.
1. Sie können diese Elemente zu mehreren E-Mail-Varianten kombinieren. Beispielsweise können Sie einen Teil einer E-Mail duplizieren, indem Sie eine Strukturkomponente markieren und in der kontextuellen Symbolleiste **[!UICONTROL Duplizieren]** auswählen.
