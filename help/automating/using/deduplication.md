...
description: Mithilfe der Deduplizierungs-Aktivität lassen sich Duplikate in Ergebnissen aus eingehenden Aktivitäten löschen.
audience: automating
...
Mithilfe der Aktivität **[!UICONTROL Deduplizierung]** lassen sich Duplikate in Ergebnissen aus eingehenden Aktivitäten löschen.
...
1. Bestimmen Sie die **[!UICONTROL Anzahl der beizubehaltenden eindeutigen Datensätze]**. Der Standardwert dieses Felds ist 1. Mittels des Werts 0 lassen sich alle Duplikate beibehalten.

   Nehmen wir z. B. den Fall, dass die Datensätze A und B wie Duplikate des Datensatzes Y und ein Datensatz C wie eine Dublette des Datensatzes Z angesehen werden:
...
1. Definieren Sie die Kriterien zur **[!UICONTROL Identifizierung der Duplikate]**, indem Sie der dafür vorgesehenen Liste Bedingungen hinzufügen. Geben Sie die Felder und/oder Ausdrücke an, für die sich mittels identischer Werte Duplikate identifizieren lassen: E-Mail-Adresse, Nachname, Vorname etc. Mithilfe der Reihenfolge der Bedingungen lässt sich die Priorität ihrer Bearbeitung bestimmen.
