...
uuid: 69 af 12 cc -6 f 82-4977-9 f 53-aa 7 bc 26 f 5 d 7 e 7 e
...
1. Prüfen Sie im **[!UICONTROL Dateistruktur]-Tab die automatisch erkannte Struktur der Beispieldatei.**
   ...
   * Sie können die Standarderkennungsparameter verändern, um Sie Ihrer Datei anzupassen. Im Feld **[!UICONTROL Dateityp]können Sie angeben, ob die zu importierende Datei aus Spalten mit fester Länge bestehen soll.** In diesem Fall müssen Sie im Tab **[!UICONTROL Spaltendefinition]auch die maximale Zeichenanzahl für jede Spalte festlegen.**
      ...
      Im Bereich **[!UICONTROL Dateiformat]** können Sie mit der Option **Prüfen Sie die Spalten in der Datei bezüglich der Spaltendefinitionen]überprüfen, ob die Spalten der hochgeladenen Datei mit der Spaltendefinition übereinstimmt.[!UICONTROL **
...
1. Prüfen Sie im **[!UICONTROL Spaltendefinition]-Tab das Datenformat jeder Spalte und passen Sie gegebenenfalls die Parameter an.**
   ...
   Sie können beispielsweise die Bezeichnung einer Spalte ändern, deren Typ (Zeichenfolge, Ganzzahl, Datum usw.) auswählen oder sogar die Fehlerverarbeitung angeben.
...
1. Sollte die Datei, deren Daten Sie laden möchten, in einer GZIP-Datei (.gz) komprimiert sein, wählen Sie im Feld **[!UICONTROL Vorab-Bearbeitungsetappe hinzufügen]** die Option **Datei-Dekomprimierung]aus.[!UICONTROL ** Dadurch lässt sich die Datei dekomprimieren, bevor Sie mit dem Laden der Daten fortfahren. Diese Option steht nur zur Verfügung, wenn die Datei mit der in die Aktivität eingehenden Transition übermittelt wird.
...
* **[!UICONTROL Format und Trennzeichen]**, **Eigenschaften**: Geben Sie die Eigenschaften eines Texts, der Uhrzeit, des Datums und des numerischen Wertes sowie des durch den Spaltenkontext angegebenen Trennzeichens an.
   ...
   * **[!UICONTROL Uhrzeitformat]**, **[!UICONTROL Datumsformat]**: Legen Sie das Format für **Datum**, **Uhrzeit** und **Datum und Uhrzeit** fest.
...
1. Schließen Sie eine **[!UICONTROL Datei laden]**-Aktivität an die Aktivität **Dateiübertragung]an.[!UICONTROL **
1. Markieren Sie die Aktivität und öffnen Sie sie mithilfe der ![-Schaltfläche aus den angezeigten Quick Actions.](assets/edit_darkgrey-24px.png)
1. Kreuzen Sie im Tab **[!UICONTROL Ausführung]** im Bereich **[!UICONTROL Zu ladende Datei]die Option** Datei der eingehenden Transition verwenden] an.**[!UICONTROL **

   ![](assets/wkf_file_loading8.png)

1. Konfigurieren Sie die Aktivität wie oben beschrieben.
1. Schließen Sie nun ein **[!UICONTROL Daten-Update]** an die **Datei laden]-Aktivität an und konfigurieren Sie es.[!UICONTROL ** Lesen Sie diesbezüglich auch den Abschnitt [Daten-Update](../../automating/using/update-data.md).
