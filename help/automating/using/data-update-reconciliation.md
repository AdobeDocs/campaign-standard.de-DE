...
Das folgende Beispiel zeigt einen Workflow zur Erstellung einer Profil-Zielgruppe, die direkt von einer importierten Datei mit neuen Kunden ausgeht. Er setzt sich aus folgenden Aktivitäten zusammen:
...
* Aktivität [Zielgruppe speichern](../../automating/using/save-audience.md) zum Speichern der Profil-Zielgruppe.
