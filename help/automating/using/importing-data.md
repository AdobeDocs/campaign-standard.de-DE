...
Sobald die Anfrage verarbeitet wurde, stehen die Verschlüsselungs-/Entschlüsselungsbefehle im Feld **!UICONTROL Vorab-Bearbeitungsetappe **der Aktivitäten**[!UICONTROL  Daten laden (Datei)]** und **[!UICONTROL Daten extrahieren (Datei)]**zur Verfügung. Diese können Sie zum Entschlüsseln oder Verschlüsseln der Dateien verwenden, die Sie importieren oder exportieren möchten.
